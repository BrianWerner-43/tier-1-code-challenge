...
/*
  ...
  { tile: 'A', score: 1 }
*/
// pushed the objects into the empty array
...
console.log('myScrabbleTiles', 'is', myScrabbleTiles);
...
function sumTiles(anArray) {
  let sum =0; // hold the sum of tile object scores

  // for loop to iterate over anArray an add each score to sum variable
